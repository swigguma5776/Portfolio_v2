...
export const Contact = () => {
    return (
        <Stack direction = 'column' width='60%' padding='30px' alignItems='center' textAlign='center' mt='200px' mb='200px'>
            ...
            <Typography variant='h6' color='primary.light' width={{md:'500px', xs: '300px'}}>
            I'm currently searching for my next big adventure as a Back-end Software Engineer. Feel free to reach out to 
